...
description: Find people on LinkedIn and send personalized connection requests. Supports multiple strategies based on goal â€” networking (search posts), sales (search by role/company), partnerships (combine both), hiring (search by skills), or market research (analyze posts + comments). Each connection note is unique and personalized. Requires the rethinksoft browser automation MCP server and Chrome extension.
---
...
- **Use RethinkSoft only for browser-required steps**: LinkedIn is a logged-in UI with no public API for prospecting â€” the browser is genuinely needed here.
...
1. **Goal** â€” networking, sales, partnerships, hiring, or market research
2. **Topic** â€” what area, industry, or product (e.g., "browser automation", "AI DevTools")
3. **Count** â€” how many people (default 15)
...
**Networking / community building** â†’ Search LinkedIn POSTS. Find people actively talking about the topic. Vocal, engaged people â€” great for community.
```
...
- **Found via people search**: Visit their profile â€” look for recent job change, About section, featured content, recent activity, mutual connections, company news
...
- **Profile-based**: "Saw you're leading [team/initiative] at [company] â€” I'm building [relevant thing] and think there's overlap."
- **Job-change-based**: "Congrats on the move to [company]! I work on [relevant thing] that might be useful as you settle in."
- **Mutual-connection-based**: "We both know [person] â€” noticed you're working on [thing] and thought we should connect."
